...
var SignupComponent = React.createClass({
    ...
    processErrorCode : function(errorCode){
      ...
      var message
      switch(errorCode){
        default:message = 'We are very sorry, an unknown exception occured during login. Our support staff has been notified and will investigate the problem as soon as possible.';break
      }
      ...
      var emailSignupForm = <form id="email_signup" className="form"
        ...
        <div className="accept_terms"
          ...
          <input id="accept_terms" type="checkbox"
                 ...
                 checked={state.terms} />
          <label htmlFor="accept_terms">Accept <A plain href="/terms" target="_blank">Terms</A> and <A plain href="/privacy" target="_blank">Privacy Policy</A></label>
          {this.formatFieldError('terms')}
        </div>
        <hr />
        <button className="btn btn-lg btn-c2a btn-block "
                type="submit">
