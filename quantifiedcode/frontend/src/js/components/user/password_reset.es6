            ...
            if (this.state.success)
                return <div className="row">
                    <div className="col-md-6 col-md-offset-3">
                        <h2 className="monster-headline text-center">Success</h2>
                        <p>Your password has been changed.</p>
                        <A href={makeUrl('/user/login')}
                           className="btn btn-lg btn-primary btn-block">Log in</A>
                    </div>
                </div>
            else
                return <div className="row">
                    <div className="col-md-6 col-md-offset-3">
                        <h2 className="monster-headline text-center">An error occured</h2>
                        <p>An error occured, please try requesting another password reset token.</p>
                        <A href={makeUrl('/user/password-reset-request')}
                           className="btn btn-lg btn-primary btn-block">Request password reset</A>
                    </div>
                </div>
        }
        return <div className="row">
                    <div className="col-xs-12">
                        <h2 className="monster-headline text-center">Reset your Password</h2>
                    </div>
