...
var ValidateComponent = React.createClass({
    ...
    renderErrorPage : function(errorData){
        ...
        return <div className="row">
            <div className="col-md-7 col-center text-center">
                <h2 className="monster-headline-text">Validation not successful</h2>
    ...
    render : function(){
        ...
        var button = <A className="btn btn-md btn-primary" href={makeUrl("/user/login")}>Log in</A>

        if (Utils.isLoggedIn())
            button = <A className="btn btn-md btn-primary" href={makeUrl("/projects")}>View your projects</A>

        return <div className="row">
                    <div className="col-md-7 col-center text-center">
                        <h2 className="monster-headline-text">Validation successful</h2>
