...
var EmailLoginComponent = React.createClass({
    ...
    return (
      <form className="form"
        ...
        <fieldset>
          ...
          <button id="login-button" className="btn btn-lg btn-c2a btn-block" type="submit"><span className="text">Log in</span></button>
