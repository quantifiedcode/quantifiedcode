...
var ParameterFilter = React.createClass({
  ...
  propTypes: {
    ...
    currentFilter: React.PropTypes.oneOfType([
      React.PropTypes.any,
    ...
    multipleChoice: React.PropTypes.bool,
    ...
    resetDefaultLabel: React.PropTypes.string,
