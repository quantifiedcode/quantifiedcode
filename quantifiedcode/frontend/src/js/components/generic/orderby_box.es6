...
var OrderByBox = React.createClass({
    displayName: "OrderByBox",

    propTypes: {
      //the available sort orders
      sortOrders: React.PropTypes.arrayOf(React.PropTypes.shape({
        title: React.PropTypes.string.isRequired,
        key: React.PropTypes.string.isRequired,
        defaultDirection: React.PropTypes.oneOf(["desc", "asc"])
      }.isRequired)).isRequired,
      //the currently selected filter criterion
      sort: React.PropTypes.string,
      //the currently selected sort direction
      direction: React.PropTypes.oneOf(["desc", "asc"]),
