...
import $ from "jquery"
var IssuesFilters = React.createClass({
    ...
    propTypes: {
      ...
      issues: React.PropTypes.any.isRequired,
      ...
      filterAttributes: React.PropTypes.arrayOf(React.PropTypes.string),
      //which attributes are multiple choice attributes
      multipleChoiceAttributes: React.PropTypes.objectOf(React.PropTypes.bool),
      //the currently selected filters
      filters: React.PropTypes.objectOf(React.PropTypes.any).isRequired,
      //additional filters which should be displayed in this filter list
      additionalFilters: React.PropTypes.func,
    },
