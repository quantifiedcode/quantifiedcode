...
var LoaderMixin = {
    ...
    showErrorMessage : function(){
        ...
        if (!this.isInvalidRoute && !Utils.isLoggedIn())
            loggedOutMessage = <p className="alert alert-danger">It seems that you are logged out. <A href={makeUrl("/user/login",{redirect_to : this.props.baseUrl})}>Logging in</A> might solve the problem.</p>
            ...
            return <div className="e404">
                        <div className="row">
                            ...
                            <div className="col-md-12 text-center">
                                <p>
                                    <a className="btn btn-md btn-primary space-right-10 space-bottom-10" onClick={reload}>Reload page</a>
                                    <a className="btn btn-md btn-default space-bottom-10" href="/contact">Contact us</a>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    showLoadingMessage : function(){
        ...
        if (this.inlineComponent) {
            ...
            return <p className="inlineLoader"><i className="fa fa-spin fa-refresh"/> {loadingMessage}</p>
        } else {
