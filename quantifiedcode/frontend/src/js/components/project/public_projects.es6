...
var PublicProjects = React.createClass({
        ...
        intro = <div className="row">
          <div className="col-xs-12">
            <div className="alert alert-warning" role="alert">
              ...
              <h4>Hi there!</h4>
              <p>
                This is a list of public Python projects that we have analyzed on our platform. By checking the source code of each project against a list of Python <A href="/app/issue_classes">anti-patterns</A>, we help to keep it free of bugs.
                To add your own project, <A href={makeUrl("/user/signup")}>sign up for free.</A>
              </p>
            </div>
          </div>
        </div>
